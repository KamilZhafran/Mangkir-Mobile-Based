...
Future<List<Recipe>> searchRecipe(String keyword, String kategori, String durasi) async {
  final Map<String, String> headers = {'Content-Type': 'application/json'};
    final uri = Uri.parse('http://192.168.0.110:8000/api/search')
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      leading: Container(
                        ...
                        height: 60,
                        decoration: BoxDecoration(
                          color: Colors.blue, // Replace with your desired color or image
